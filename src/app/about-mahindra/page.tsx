    ...
    <div>
      <div className='marginal text-[#58595b] text-md'>
        ...
        <div className='mt-5'>
          ...
          <p className='mb-3'>
            At Mahindra Group, our sustainability vision ‘Together we Rise for Planet Positive’ embodies our resolve to lead global ESG
action by integrating environmental stewardship, circularity and inclusive progress across all facets of our business.
          </p>
          <div>
            <div className='w-[80%] mx-auto'>
