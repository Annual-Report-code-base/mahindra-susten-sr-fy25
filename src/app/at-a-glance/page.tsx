  ...
  return (
    <div>
      <div className='marginal text-[#58595b] text-md'>
        ...
        <img src="/AtAGlance/image1.png" alt="Business Portfolio Diagram" className='md:w-[80%] mx-auto' />
      </div>
      ...
      <div className='bg-gradient-to-b from-[#ade3e6] to-white'>
        <div className='marginal pt-12 pb-12'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-5 gap-6 mt-10'>
            <div className='lg:col-span-4 relative rounded-xl overflow-hidden shadow-xl flex'>
              <img src="/AtAGlance/RUVNL (1).webp" alt="" className='object-cover scale-170' />
            </div>

            <div className='lg:col-span-1 relative p-4 lg:p-6 border border-gray-300 rounded-xl shadow-lg bg-white mt-8 lg:mt-0'>
              ...
              <div className='pt-6 lg:pt-0'>
                ...
                <div className='flex justify-center mb-4'>
                  <div className='h-50 w-150 rounded-2xl overflow-hidden bg-[#d8e6e2] flex justify-center'>
                ...
                <p className='text-sm mb-4'>
                  Our financial strategy continues
                  to prioritize sustainability-led
                  investments that deliver both
                  long-term value and measurable
                  environmental benefits. Guided
                  by our vision to be a leading
                  provider of sustainable energy
                  solutions, we ensure that
                  financial planning and capital
                  allocation not only advance our
                  low-carbon journey but also
