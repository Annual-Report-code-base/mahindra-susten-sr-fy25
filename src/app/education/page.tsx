        ...
        <div className='marginal text-[#58595b] text-md'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 items-start mb-8'>
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/ms/Sketch/Education.webp')"
              }}
            >
            </div>
          </div>
        ...
        <div className='mb-8'>
          ...
          <div className='overflow-x-auto'>
            <table className='w-full border-collapse'>
              <thead>
                <tr>
                  <th className='bg-[#05acc4] text-white p-3 text-left font-bold'>Name of School</th>
                  <th className='bg-[#60ccdd] text-[#005c33] p-3 text-left font-bold'>Location</th>
                  <th className='bg-[#65acac] text-white p-3 text-center font-bold'>Year of activity</th>
                  <th className='bg-gray-600 text-white p-3 text-center font-bold'>FY23 nos.</th>
                  <th className='bg-[#f8a923] text-white p-3 text-center font-bold'>FY24 nos.</th>
                  <th className='bg-[#e0a237] text-white p-3 text-center font-bold'>FY24 %inc.</th>
                  <th className='bg-[#c59034] text-white p-3 text-center font-bold'>FY25 nos.</th>
                  <th className='bg-[#a4782d] text-white p-3 text-center font-bold'>FY25 %inc.</th>
                  <th className='bg-gray-600 text-white p-3 text-center font-bold'>Steam</th>
                </tr>
              </thead>
              <tbody>
