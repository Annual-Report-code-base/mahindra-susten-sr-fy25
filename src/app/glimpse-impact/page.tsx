                ...
                <div className='marginal text-[#58595b] text-md'>
                    ...
                    <div className='grid grid-cols-3 gap-6'>
                        ...
                        <div className=' p-6 rounded-lg border-b-4 border-[#4caf50]'>
                            ...
                            <h2 className='text-[#4caf50] text-4xl font-bold mb-2'>SBTi</h2>
                            <p className=''>targets approved in Dec'24</p>
                        </div>

                        <div className=' p-6 flex flex-col justify-end rounded-lg border-b-4 border-[#4caf50]'>
                            <h2 className='text-[#4caf50] text-4xl font-bold mb-2'>21+</h2>
                        ...
                        {/* Row 2 */}
                        <div className=' p-6 rounded-lg border-b-4 border-[#4caf50]'>
                            <h2 className='text-[#4caf50] text-4xl font-bold mb-2'>5 GWp+</h2>
                            <p className=''>Portfolio (Execution till date)</p>
                        </div>

                        <div className=' p-6 rounded-lg border-b-4 border-[#4caf50]'>
                            <h2 className='text-[#4caf50] text-4xl font-bold mb-2'>55.08 <span className='text-4xl'>Mn+</span></h2>
                            <p className=''>Safe Man Hours till date</p>
                        </div>

                        <div className=' p-6 rounded-lg border-b-4 border-[#4caf50]'>
                            <h2 className='text-[#4caf50] text-4xl font-bold mb-2'>3.02 <span className='text-4xl'>Lakhs</span></h2>
                            <p className=''>Lives Impacted through CSR (since 2016)</p>
                        </div>

                        {/* Row 3 */}
                        <div className=' p-6 rounded-lg border-b-4 border-[#4caf50]'>
                            <h2 className='text-[#4caf50] text-4xl font-bold mb-2'>3.6 GWp+</h2>
                            <p className=''>Total projects under development pipeline</p>
                        </div>

                        <div className=' p-6 rounded-lg border-b-4 border-[#4caf50]'>
                            <h2 className='text-[#4caf50] text-4xl font-bold mb-2'>Zero</h2>
                            <p className=''>No of complaints received on non-compliance</p>
                        </div>

                        <div className=' p-6 rounded-lg border-b-4 border-[#4caf50]'>
                            <h2 className='text-[#4caf50] text-4xl font-bold mb-2'>100%</h2>
                            <p className=''>ESIA & CCRA completed for ongoing projects</p>
                        </div>

                        {/* Row 4 */}
                        <div className=' p-6 flex flex-col justify-end rounded-lg border-b-4 border-[#4caf50]'>
                            <h2 className='text-[#4caf50] text-4xl font-bold mb-2'>1<sup>st</sup></h2>
                        ...
                        <div className=' p-6 flex flex-col justify-end rounded-lg border-b-4 border-[#4caf50]'>
                            <h2 className='text-[#4caf50] text-4xl font-bold mb-2'>₹1,448<br /><span className='text-4xl'>crore</span></h2>
