      ...
      <div className='marginal text-[#58595b] text-md'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-5'>
          ...
          <div className='border-b-4 border-[#f6a537] pb-6'>
            ...
            <div className='border-t-4 border-[#f6a537] pt-6'>
              ...
              {/* MALT */}
              <div className='border-t-4 border-[#65acac] pt-6'>
        ...
        <div className='mb-5'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-5'>
            <img
              ...
              className='w-full h-95 object-cover rounded-4xl'
            />
            <img
        ...
        <div className='relative p-[1px] rounded-3xl bg-gradient-to-r from-[#f6a537] to-[#65acac]'>
