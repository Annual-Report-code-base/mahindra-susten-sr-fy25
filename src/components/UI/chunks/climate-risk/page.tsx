            ...
            <div>
              ...
              <div className='overflow-x-auto'>
                <table className='w-full border-collapse'>
                  <thead>
                    <tr>
                      <th className='bg-[#005c33] text-white p-3 text-left font-bold text-sm'>Strategic Measures</th>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12'>
            ...
            <div className='lg:col-span-8'>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <div>
                  <div className='flex items-center gap-3 mb-3'>
                    <div className='w-12 h-12 rounded-full bg-[#005c33] flex items-center justify-center text-white font-bold text-xl flex-shrink-0'>
                      2
                    </div>
                    <h5 className='text-lg font-bold text-[#005c33]'>
