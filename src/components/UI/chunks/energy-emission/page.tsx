    ...
    <div>
      <div className='marginal text-[#58595b] text-md'>
        ...
        <div className='mb-5'>
          ...
          <img src="/EnergyEmission/graph1.png" alt="" className='mb-8' />
          <img src="/EnergyEmission/graph2.png" alt="" className='mb-8' />
          <img src="/EnergyEmission/graph3.png" alt="" className='mb-5' />
        </div>
