  ...
  return (
    <div>
      <div className='marginal text-[#58595b] text-md'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-5'>
          ...
          <div className='bg-gray-100 rounded-lg p-6'>
            ...
            <p className='text-[#58595b] mb-4 italic'>
              "As a mother, balancing my career and responsibilities at home has always been challenging. But thanks to the organization's policies, especially the Babycare Allowance and Daycare Facility Reimbursements, I have received support that I could have never imagined. These policies have eased the financial burden and given me peace of mind, allowing me that Mahindra Susten values both my professional identity and my role as a parent.
            </p>
        ...
        <div className='relative p-[3px] rounded-2xl border-2 border-[#40ad48] mb-12'>
